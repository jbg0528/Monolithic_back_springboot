...
public class RespondentService {
    ...
    @SneakyThrows
    @Transactional
    public String getRespondentSurvey(Long surveyId){
        ...
        for(int i=0;i<Ques_list.size()-1;i++){
        ...
        //List<Grid> Grid_list=gridRepository.findGridByQuestion_Id()
        //List<Essay> Essay_list=essayRepository.findEssayByQuestion_Id()
    }
}
